...
import com.demo.complete.command.CommandLogDecorator;
...
import com.demo.complete.command.macro.AdventurerMovementMacro;
import com.demo.complete.factory.CommandFactory;
import com.demo.complete.factory.v1.ConcreteCommandFactory;
...
public class Main {
    ...
    private static void scenario5() {
        ...
        CommandFactory commandFactory = new com.demo.complete.factory.v2.ConcreteCommandFactory();
